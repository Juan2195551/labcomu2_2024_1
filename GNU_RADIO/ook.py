...
class ook(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_add_const_vxx_1_0 = blocks.add_const_ff((math.pi/3))
        self.blocks_add_const_vxx_1 = blocks.add_const_ff((-0.8))
        ...
        self.connect((self.blocks_add_const_vxx_1_0, 0), (self.epy_block_0, 0))
        self.connect((self.blocks_add_const_vxx_1_0, 0), (self.epy_block_0_0, 0))
        ...
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.blocks_add_const_vxx_1_0, 0))
